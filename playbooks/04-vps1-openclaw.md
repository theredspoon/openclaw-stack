...
| `deploy/openclaw.json` | `<INSTALL_DIR>/instances/<name>/.openclaw/openclaw.json` | template | Deployed per-claw by `deploy-config.sh` |
| `deploy/models.json` | `<INSTALL_DIR>/instances/<name>/.openclaw/agents/*/agent/models.json` | template | Deployed per-claw, per-agent (main, code, skills) |
