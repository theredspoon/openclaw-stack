...
| `deploy/openclaw.json` | `/home/openclaw/instances/<name>/.openclaw/openclaw.json` | template | Deployed per-claw by `deploy-config.sh` |
| `deploy/models.json` | `/home/openclaw/instances/<name>/.openclaw/agents/*/agent/models.json` | template | Deployed per-claw, per-agent (main, code, skills) |
